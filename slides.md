...
comark: true
slide_info: false
neversink_slug: 'AI 概論與實作體驗基礎教學手冊'
---
...
<h2 style="font-size: 2rem;">燒錄 (上傳) 程式流程</h2>
<div style="display: flex; flex-direction: column; align-items: flex-start; justify-content: center; gap: 16px;">
  <h2 style="margin: 0;">Step 1：要在開發板管理員檢查是否有偵測到 USB，沒偵測到需要換 USB 孔或是換線。</h2>
    <div style="display: flex; align-items: center; gap: 10px;">
        <img src="./public/arduinoide8.png" style="max-width: 45%; max-height: 30vh; width: auto; height: auto; object-fit: contain;">
        <img src="./public/arduinoide9.png" style="max-height: 30vh; width: auto; height: auto; object-fit: contain;">
    </div>
</div>
...
<div style="display: flex; flex-direction: column; align-items: flex-start; justify-content: center; gap: 16px;">
  <h2 style="margin: 0;">Step 2：若開發板非 Arduino 原廠開發板，需手動選擇開發板</h2>
    <div style="display: flex; align-items: center; gap: 10px;">
        <img src="./public/arduinoide6.png" style="max-width: 45vw; max-height: 30vh; width: auto; height: auto; object-fit: contain;">
    </div>  
</div>
<div style="display: flex; flex-direction: column; align-items: flex-start; justify-content: center; gap: 16px;">
  <h2 style="margin: 0;">Step 3：先驗證 (Verify) 程式無問題後上傳 (Upload)</h2>
    <img src="./public/arduinoide10.png" style="max-width: 20vw; max-height: 20vh; width: auto; height: auto; object-fit: contain;">
    <img src="./public/arduinoide11.png" style="max-width: 20vw; max-height: 20vh; width: auto; height: auto; object-fit: contain;">
</div>
